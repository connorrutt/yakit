    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
        ...
        <g mask='url(#mask0_2721_76421)'>
            <path
                ...
                fill='#31343F'
            />
            <path d='M1 12H23' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7447)'>
            <path
                ...
                stroke-width='1.5'
            />
            <path d='M12 21V7' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <path
...
const SpecialVulnerabilityDetection = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7421)'>
            ...
            />
            <circle cx='12' cy='12' r='3' stroke='#F28B44' stroke-width='1.5' />
        </g>
    </svg>
)
...
const BatchVulnerabilityDetection = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7504)'>
            <circle cx='12' cy='12' r='10' stroke='#31343F' stroke-width='1.5' />
            <circle cx='12' cy='12' r='5' stroke='#31343F' stroke-width='1.5' />
            <circle cx='8' cy='14' r='2' fill='white' stroke='#F28B44' stroke-width='1.5' />
            <circle cx='17' cy='15' r='1' fill='white' stroke='#F28B44' stroke-width='1.5' />
            <circle cx='19' cy='5' r='1' fill='white' stroke='#F28B44' stroke-width='1.5' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7532)'>
            <path
                ...
                stroke-linejoin='round'
            />
            <path d='M2 20L22 20' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
            <path
...
const WebFuzzer = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask1_2812_7361)'>
            <path d='M4 4H13V11C13 12.1046 12.1046 13 11 13H4V4Z' stroke='#31343F' stroke-width='1.5' />
            <path
                fill-rule='evenodd'
                clip-rule='evenodd'
                ...
                fill='#F28B44'
            />
            <circle cx='15' cy='15' r='8' stroke='#31343F' stroke-width='1.5' />
            <path
        ...
        <rect x='4' y='4' width='16' height='16' rx='2' stroke='#31343F' stroke-width='1.5' />
        <path d='M4 12V6C4 4.89543 4.89543 4 6 4H12' stroke='#F28B44' stroke-width='1.5' stroke-linecap='square' />
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7610)'>
            ...
            <path
                ...
                fill='#F28B44'
            />
            <path d='M12 2V22' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7637)'>
            ...
            <path
                ...
                stroke-width='1.5'
            />
            <path d='M9 16V19' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <path d='M12 16V19' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <path d='M15 16V19' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
        </g>
    </svg>
)
...
const ReverseConnectionServer = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7666)'>
            <rect x='4' y='8' width='16' height='4' rx='2' stroke='#31343F' stroke-width='1.5' />
            <rect x='4' y='4' width='16' height='4' rx='2' stroke='#31343F' stroke-width='1.5' />
            <path d='M12 14V17' stroke='#F28B44' stroke-width='1.5' />
            <path
            ...
            <circle cx='4.5' cy='18.5' r='1.5' stroke='#31343F' stroke-width='1.5' />
            <circle cx='12' cy='18.5' r='1.5' stroke='#F28B44' stroke-width='1.5' />
            <circle cx='19.5' cy='18.5' r='1.5' stroke='#31343F' stroke-width='1.5' />
        </g>
    </svg>
)
...
const DNSLog = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7697)'>
            <rect x='3' y='4' width='18' height='16' rx='2' stroke='#31343F' stroke-width='1.5' />
            <path
            ...
            <path
                ...
                fill='#F28B44'
            />
            <path d='M6 6.5H14' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
            <path d='M17 6.5H18' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7727)'>
            ...
            <path
                ...
                stroke-width='1.5'
            />
            <path d='M2 3H22' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
            <path d='M8 13L8 10' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <path d='M12 13V8' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <path d='M16 13L16 6' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7755)'>
            ...
            <path
                ...
                stroke-linejoin='round'
            />
            <path d='M12.2859 20.8613L12.2106 11.5982' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
            <circle
                cx='12.2188'
                cy='20.9773'
                r='1.5'
                ...
                stroke-width='1.5'
            />
            <path d='M3.84809 6.64703L12 11.2656' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
            <circle
                cx='3.78097'
                cy='6.53104'
                r='1.5'
                ...
                stroke-width='1.5'
            />
            <path d='M20.4999 6.5L12.3955 11.2673' stroke='#31343F' stroke-width='1.5' stroke-linecap='round' />
            <circle cx='20.6338' cy='6.5' r='1.5' fill='white' stroke='#F28B44' stroke-width='1.5' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7819)'>
            ...
            <path
                ...
                stroke-linejoin='round'
            />
            <path d='M5.5 9L10 8' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
            <path d='M5.5 12H8.5' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
            <path d='M5.5 15L9 16' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
        </g>
    </svg>
)
...
const SpaceEngineHunter = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <mask id='mask0_166_5755' style={{maskType: "alpha"}} maskUnits='userSpaceOnUse' x='0' y='0' width='24' height='24'>
            <rect width='24' height='24' fill='#D9D9D9' />
        </mask>
        <g mask='url(#mask0_166_5755)'>
            <path
                ...
                fill='#31343F'
            />
            <path d='M20 19L22.1213 21.1213' stroke='#F28B44' stroke-width='1.5' stroke-linecap='round' />
            <circle cx='17' cy='16' r='4' stroke='#F28B44' stroke-width='1.5' />
        </g>
    </svg>
)
