        ...
        return (
            <Spin spinning={localLoading}>
                ...
                >
                    <Image
                        src={TelecomBanner}
                        style={{marginTop: 150, marginBottom: 40, height: 120}}
                        preview={false}
                        width={400}
                    />
                    <br />
                    ...
                    {mode === "local" && (
                        <>
                            <YakLocalProcess
                                onConnected={(newPort: any, newHost: any) => {
